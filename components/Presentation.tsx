...
const steps = [
  ...
  { id: 'smart-goals', title: 'Obiettivi SMART' },
  { id: 'new-content', title: 'Piano e Calendario Editoriale' },
  { id: 'metrics', title: 'Metriche vs KPI' },
  { id: 'vanity-insights', title: 'Vanity Metrics & Insights' },
  { id: 'strategy', title: 'Il Piano Editoriale' },
  { id: 'rubriche', title: 'Rubriche Creative' },
  { id: 'calendar', title: 'Il Calendario Operativo' },
  { id: 'ai-tools', title: 'AI per il Piano Editoriale' },
  { id: 'competitors', title: 'Analisi Competitor & Insight' },
  { id: 'youtube-tools', title: 'YouTube & Video Ecosystem' },
  { id: 'trends-keywords', title: 'Google Trends & Keyword Research' },
      ...
      <nav className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-emerald-600 rounded-full flex items-center justify-center text-white font-bold shadow-md shadow-emerald-100">
              FL
            </div>
            <div>
